          ...
          <tbody>
            ...
            <tr>
              <td style="font-family: 'arial';background-color: #fff; color: #000;  text-align: left; padding: 15px; font-size: 14px; line-height: 22px;">
				Dear <strong>{{ucwords($rejister_as)}}</strong>,<br><br>
				  Your are successfully registered on {{ env('APP_NAME', 'XtraClass') }}. if you do not verified your mobile number and extra details on next steps on registration form, you can do this after login into the system by click on below link.
				</td>
            </tr>
